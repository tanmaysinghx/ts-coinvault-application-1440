...
<body class="flex items-center justify-center h-screen">
    ...
    <div class="glass p-8 rounded-2xl shadow-2xl w-96">
        ...
        <form action="transfer" method="post" class="space-y-4">
            <div>
                <label class="block text-sm text-gray-400">From (Your Username)</label>
                <input type="text" name="fromUser" required
        ...
        <div class="mt-4 text-center">
            <a href="register.jsp" class="text-xs text-gray-500 hover:text-white">Back to Register</a>
        </div>
    </div>
</body>
</html>